...
if ($normalizedPath === '' || $normalizedPath === 'index.php') {
    $currentRoute = 'home';
} elseif (strpos($normalizedPath, 'pages/') === 0) {
    $currentRoute = basename($normalizedPath, '.php');
} else {
    $currentRoute = basename($normalizedPath);
}
?>
<!DOCTYPE html>
    ...
    <header class="hero-header">
        <div class="hero-header-container">
            <div class="hero-nav-row">
                <a href="<?= $basePath ?>" class="brand-link" aria-label="BlueWhois 首页">
            ...
            <div class="hero-header-copy">
                ...
                <nav class="top-nav" id="topNav">
                    <a href="<?= $basePath ?>" class="<?php echo $currentRoute === 'home' ? 'active' : ''; ?>" <?php echo $currentRoute === 'home' ? 'aria-current="page"' : ''; ?>>首页</a>
                    <div class="nav-dropdown">
                        <a href="#" class="<?php echo in_array($currentRoute, ['iana', 'cctlds'], true) ? 'active' : ''; ?>">域名 <i class="fas fa-chevron-down nav-dropdown-icon"></i></a>
                    ...
                    <a href="<?= $basePath ?>api-docs" class="<?php echo $currentRoute === 'api-docs' ? 'active' : ''; ?>" <?php echo $currentRoute === 'api-docs' ? 'aria-current="page"' : ''; ?>>API 文档</a>
                    <a href="<?= $basePath ?>about" class="<?php echo $currentRoute === 'about' ? 'active' : ''; ?>" <?php echo $currentRoute === 'about' ? 'aria-current="page"' : ''; ?>>关于</a>
                    <a href="<?= $basePath ?>contact" class="<?php echo $currentRoute === 'contact' ? 'active' : ''; ?>" <?php echo $currentRoute === 'contact' ? 'aria-current="page"' : ''; ?>>联系</a>
                </nav>
            </div>
        </div>
    </header>
